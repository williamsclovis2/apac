...
if($_participant_data_->payment_state == 'PAYABLE'):
    ?>
                                                    <a class="btn btn-xs btn-primary " target="_blank"   href="<?php linkto('admin/ebadge/'.$_participant_data_->qrCode); ?>"   > <i class="fa fa-user" aria-hidden="true"></i> Generate Badge</a>
<?php
endif;
    ?>
