...
<body>
    <div id="wrapper">
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <div class="row">
                                ...
                                <form action="<?php linkto("admin/pages/content/content_action.php"); ?>" method="post" class="formCustom" id="addQuoteForm">
                                </form>
                            </div>
                        </div>
                    </div>
        ...
        <script src="<?php linkto('admin/pages/content/quote.js'); ?>"></script>
