            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section_title mb-30">
                        <h3>About your destination for in-person sessions</h3>
                        ...
                        <div class="row destination">
                            <div class="col-md-4">
                                <img src="img/picture3.jpg" class="img img-responsive">
                            </div>
                            <div class="col-md-4">
                                <img src="img/picture1.jpg" class="img img-responsive">
                            </div>
                            <div class="col-md-4">
                                <img src="img/picture3.jpg" class="img img-responsive">
                            </div>
                            <div class="col-md-12 text-center">
                                <a href="learn" class="btn btn-primary px-5 py-2 text-white">Learn more & plan your trip</a>
                            </div>
                        </div>
                    </div>
                </div>
