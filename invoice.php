...
<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'>
        ...
        <head>
          ...
          .header {padding: 5px 30px 5px 30px;}
          ...
          .underline{border-bottom: 1px dashed #cccccc;margin-bottom: 10px;padding-bottom: 3px;margin-top: 0;font-size: 14px; text-transform:uppercase;}
          .underline span{text-transform:none !important;}
          .payment_message{color:#7A838B; margin-bottom:15px;}
        ...
        <body yahoo bgcolor='#f4f4f4'>
          <table width='100%' bgcolor='#f4f4f4' border='0' cellpadding='0' cellspacing='0'>
            <td style='padding: 20px 0 0 0;' align='center'>
                <table class=''>
                    <tr >
                        <td class='h2' style='font-family: sans-serif;'  align='center'>Dear $firstname</td>
                    </tr>
                    <tr>
                        <td  align='center'>
                            <p class='payment_message'>Your payment is successfully completed. And your registration is now activated.</p>
                        </td>
                    </tr>
                </table>
             </td>
                      ...
                      <table width='100%' border='0' cellspacing='0' cellpadding='0'>
                        ...
                        <tr>
                          <td class='bodycopy' style='font-family: sans-serif;'>
                            <p class='underline'>Payment ID  <span style='float:right;'>abcd1234567890</span></p>
                            <p class='underline'>Event  <span style='float:right;'>EventName / In-person</span></p>
                            <p class='underline'>Participation  <span style='float:right;'>African Based / Standard</span></p>
                            <p class='underline'>Full Name  <span style='float:right;'>Kambale mulwahali Clovis</span></p>
                            <p class='underline'>Payment method  <span style='float:right;'>Master card</span></p>
                            <p class='underline'>Paid Amount <span style='float:right;'>$ 200</span></p>
                            <p class='underline'>Payment status <span style='float:right; color:green;'>Success</span></p>
                            <p class='underline'>Date <span style='float:right; color:green;'>1-10-2021</span></p>
                          </td>
                        </tr>
                        </tr>
                      </table>
            ...
            <table class='buttonwrapper' bgcolor='#f47e20' border='0' cellspacing='0' cellpadding='0'>
                ...
                <td class='button' height='45'>
                    <a href='http://torusguru.com/thefuture' target='_blank'>Download  invoice</a>
                </td>
                </tr>
            </table>
            </td>
