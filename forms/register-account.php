<div class="service_area about_event" style="background: #000; display: none;" id="account_area">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                <form  class="form-contact" id="accountForm" method="post">
                    ...
                    <div class="form-group mt-2" style="overflow: auto;">
                        <input type="hidden" name="request" value="account-password-creation">
                        ...
                        <button type="button" id="accountButton" authtoken="" class="btn btn-primary px-5 py-2 text-white pull-right registerACPFormSubmit">Save</button>
                    </div>
                </form>
            </div>
            <div class="col-lg-2"></div>
