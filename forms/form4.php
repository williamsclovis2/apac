            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-12">
                    <div class="slider_text slider_text_register">
                        ...
                        <h5 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s" style="text-transform: none;"><?= ucfirst($_EVENT_TYPE_NAME_) ?>  </h5>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-sm-9 field-validate">
                                    <input class="form-control"  oninput="validate(this)" id="media_card_number" name="media_card_number" placeholder="Press card number" data-rule="required" data-msg="Please enter press card number"/>
                        ...
                        <div class="form-group col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-sm-9 field-validate">
                                    <input class="form-control" oninput="validate(this)"  id="media_card_authority" name="media_card_authority" placeholder="Enter Issuing Authority" data-rule="required" data-msg="Please enter issuing authority"/>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-sm-9 field-validate">
                                    <textarea class="form-control w-100" oninput="validate(this)"  name="media_equipment" id="media_equipment" cols="30" rows="9" placeholder="Eg: Camera, Microphone ..." data-rule="required" data-msg="Please enter equipment"></textarea>
                        ...
                        <div class="form-group col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control w-100" oninput="validate(this)"  name="special_request" id="special_request" cols="30" rows="9" placeholder="eg. Sessions cover,..."></textarea>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-sm-9 field-validate">
                                    <textarea name="firt_objective" oninput="validate(this)"  id="firt_objective" class="form-control" placeholder="Type your objective" data-rule="maxlen:1020" data-msg="Please only 500 characters" style="height: 70px;"></textarea>
                        ...
                        <div class="form-group col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-sm-9 field-validate">
                                    <textarea name="second_objective" oninput="validate(this)"  id="second_objective" class="form-control" placeholder="Type your objective" data-rule="maxlen:1020" data-msg="Please only 500 characters" style="height: 70px;"></textarea>
