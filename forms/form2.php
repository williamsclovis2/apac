                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-sm-9 field-validate">
                                    <input type="text" oninput="validate(this)"  name="telephone" id="telephone" class="form-control" data-rule="required" data-msg="Please enter telephone"/>
                        ...
                        <div class="form-group col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-sm-9 field-validate">
                                    <input type="text"  oninput="validate(this)" name="telephone_2" id="telephone_2" class="form-control"/>
                                    <div class="validate" id="telephone_error"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-sm-9 field-validate">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <select id="non_african_country" onchange="validate(this)"  name="organisation_country" class="form-control" data-rule="required" data-msg="Please select country"/>
                                                <option></option>
                                            </select>
